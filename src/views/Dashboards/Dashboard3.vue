    ...
    <b-row>
      <b-col lg="4">
        ...
        <iq-card
          ...
          class-name="iq-card-height2 iq-card-block"
        >
          <template v-slot:body>
            <div class="d-flex align-items-center justify-content-between">
              ...
              <b-col md="6">
                <div
                  class="progress-round patient-progress mx-auto"
                  data-value="80"
                >
        ...
        <iq-card body-class="pb-0">
          <template v-slot:body>
            <b-row>
              <b-col sm="12">
                <iq-card
                  body-class="iq-card-body bg-primary rounded-4 pt-2 pb-2 pe-2"
                >
                  <template v-slot:body>
                    <div
                    ...
                    >
                      ...
                      <div class="rounded-4 iq-card-icon bg-white">
                        <img
                          src="../../assets/images/page-img/37.png"
                          class="img-fluid"
                          alt="icon"
                        />
                      </div>
                    ...
                    <b-row>
                      <b-col md="4">
                        <div class="training-block d-flex align-items-center">
                          <div
                            class="rounded-circle iq-card-icon iq-bg-primary"
                          >
                            <img
                      ...
                      <b-col md="4">
                        <div class="training-block d-flex align-items-center">
                          ...
                          >
                            <img
                              src="../../assets/images/page-img/36.png"
                              class="img-fluid"
                              alt="icon"
                            />
                          </div>
              ...
              <b-col lg="4">
                ...
                >
                  ...
                  <template v-slot:headerAction>
                    <b-dropdown
                      variant="dropdown-toggle iq-bg-primary btn"
                  ...
                  <template v-slot:body>
                    ...
                    <table
                      class="table mb-0 table-borderless mt-4 table-box-shadow"
                    >
                      <thead>
                        <tr>
                          <th scope="col">Training</th>
              ...
              <b-col md="6">
                <iq-card
                  body-class="p-0"
                  header-class="p-0 bg-white min-height-auto mb-1"
                >
                  <template v-slot:headerTitle>
