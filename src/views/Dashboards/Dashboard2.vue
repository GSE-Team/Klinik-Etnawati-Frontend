    ...
    <b-row>
      ...
      <b-col lg="4">
        ...
        >
          <template v-slot:body>
            <img
              src="../../assets/images/page-img/39.png"
    ...
    <b-row>
      <b-col lg="4">
        <iq-card>
          ...
          <template v-slot:body>
            <h2>
              3,897<span class="text-success font-size-14 ms-3 me-3"
                ><i class="ri-arrow-up-fill me-2"></i>+3.3%</span
              ><small class="text-secondary font-size-14"
                >Generated by clients</small
              >
            </h2>
                ...
                >
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck11"
                      >You should check in some of below.</label
                    >
                  </div>
                  <div>
                ...
                >
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck10"
                      >Get the address of customer</label
                    >
                  </div>
                  <div>
                    <i class="ri-close-line float-end"></i>
                ...
                >
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck12"
                      >Contact Vendor for parcel</label
                    >
                  </div>
                  <div>
                    <i class="ri-close-line float-end"></i>
                ...
                >
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck14"
                      >Pick up for order no. 334</label
                    >
                  </div>
                  <div>
                    <i class="ri-close-line float-end"></i>
                ...
                >
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck15"
                      >Pay taxes for every bill</label
                    >
                  </div>
                  <div>
                    <i class="ri-close-line float-end"></i>
                ...
                >
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck16"
                      >I am designers &amp; I have no life</label
                    >
                  </div>
                  <div>
                    <i class="ri-close-line float-end"></i>
                ...
                >
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck18"
                      >You should check in on some of below.</label
                    >
                  </div>
                  <div>
                    <i class="ri-close-line float-end"></i>
